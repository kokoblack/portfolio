...
export const project = [
  {
    image: winamp,
    desc: "Winamp is created with react and tailwind css with Spotify and Google API to fetch music and videos data and also play songs and videos. You can also search for artist, album and tracks.",
    name: "Winamp",
  ...
  {
    image: gpt3,
    desc: "A modern responsive landing page with React ",
    name: "Gpt3",
